...
class TwelveDataClient:
    ...
    def fetch_time_series(self, symbol: str) -> List[Dict]:
        params = {"symbol": symbol, "interval": settings.INTERVAL, "outputsize": settings.OUTPUTSIZE, "apikey": self.api_key}
    ...
    def fetch_latest(self, symbol: str) -> Optional[Dict]:
        params = {"symbol": symbol, "interval": settings.INTERVAL, "outputsize": 1, "apikey": self.api_key}
